...
const labelsDefault = [
    ...
    },
    {
        ...
        "color": "008000",
        "description": "Don't worry about it. At least for now... But don't forget about it!"
    },
    {
        "name": "Priority: Medium :tornado:",
        "color": "FFFF32",
        "description": "I guess you should go take a look? Maybe this week still?"
    },
    {
    ...
    },
    {
        ...
        "color": "ff8000",
        "description": "Tell them you're working on it. Lie to them. Go!"
    },
    {
...
function fileExists() {
    if (!fs.existsSync(labelFile)) {
        fs.writeFileSync(labelFile, JSON.stringify(labelsDefault, null, 4), function (err) {
            if (err) throw err
        });
    }
}
...
function readSync() {
    fileExists()
    return JSON.parse(fs.readFileSync(labelFile))
}

// Writes file
function writeSync(data) {
    fs.writeFileSync(labelFile, JSON.stringify(data, null, 4));
}
