...
function upload(msg, exit) {
    console.log(chalk.greenBright("Upload: ") + msg)
    if (exit) process.exit()
}
...
// Rainbow
function rainbow() {
    console.log(chalkRainbow("https://media.giphy.com/media/jki7wmDaDObPq/giphy.gif?YouActuallyFoundOut=ThatsAmazing?LetMeKnowYoureSpecial=http://discordapp.com/users/241655863616471041"))
    process.exit()
}
